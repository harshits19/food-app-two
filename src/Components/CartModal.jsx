        ...
        <div className="relative mx-auto mb-10 min-w-[300px] max-w-[520px] bg-white p-[30px] shadow-[0_2px_20px_0_#282c3f80]">
          <div className="relative">
            ...
            <div className="flex justify-between gap-x-4 pt-6 text-base font-bold ">
              <button
                className="text-defGreen border-defGreen w-full border-2 py-3 uppercase hover:shadow-[0_4px_14px_#d4d5d9]"
                onClick={() => dispatch(setError(false))}
              >
                No
              </button>
              <button
                className="bg-defGreen w-full py-3 uppercase text-white hover:shadow-[0_4px_14px_#d4d5d9]"
